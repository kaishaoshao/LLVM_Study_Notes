module {
  ...
  ^bb2:  // pred: ^bb1
    %12 = builtin.unrealized_conversion_cast %8 : index to i64
    %13 = builtin.unrealized_conversion_cast %9 : index to i64
    %14 = llvm.add %13, %12 : i64
    %15 = builtin.unrealized_conversion_cast %14 : i64 to index
    %16 = llvm.add %10, %6 : i64
    %17 = builtin.unrealized_conversion_cast %16 : i64 to index
    cf.br ^bb1(%17, %15 : index, index)
  ^bb3:  // pred: ^bb1
    %18 = builtin.unrealized_conversion_cast %9 : index to i64
    llvm.return %18 : i64
  }
  llvm.func @main() -> i32 {
